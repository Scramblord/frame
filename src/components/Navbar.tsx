          ...
          <div className="flex items-center justify-between gap-3">
            ...
            >
              <img
                src="/logo.png"
                alt=""
                className="frame-navbar-logo h-8 w-auto shrink-0"
                width={58}
                height={32}
              />
