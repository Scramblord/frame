-- Marketplace search: expert keywords + active service names/descriptions.
-- Requires public.services (008_services.sql). Apply manually in Supabase SQL Editor if needed.
